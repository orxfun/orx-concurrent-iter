...
fn con_iter_of_vec_drain(c: &mut Criterion) {
    ...
    Exp.bench(c, "con_iter_of_vec_drain", &treatments, &variants);
}

criterion_group!(benches, con_iter_of_vec_drain);
