use crate::implementations::jagged_arrays::{RawSlice, jagged_slice::RawJaggedSlice};
...
pub struct RawJaggedSliceIterRef<'a, T> {
    slice: RawJaggedSlice<'a, RawSlice<'a, T>, T>,
...
impl<'a, T> RawJaggedSliceIterRef<'a, T> {
    pub(crate) fn new(slice: RawJaggedSlice<'a, RawSlice<'a, T>, T>) -> Self {
        Self {
